...
public class AllWidgets extends JFrame {
    ...
    public AllWidgets() {
        ...
        constraints.insets = new Insets(0, 5, 0, 5);  // Pixel spacing above, left, below, and right
        ...
        constraints.anchor = GridBagConstraints.CENTER;  // Position widget center left in cell - options:
