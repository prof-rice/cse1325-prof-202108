...
public class EasyWidgets extends JFrame {
    ...
    public void onButtonClick() {
        ...
        else result = comboEnum.getSelectedItem().toString() + " was selected";
        JOptionPane.showMessageDialog(this, result);
    }

    public static void main(String[] args) {
        // Run this class as a window (that is, a JFrame)
        (new EasyWidgets()).setVisible(true);
    }
}
